...
Version 0.1.44 is the current published release. The maintainer explicitly
authorized a manual Linux x86-64 release after the complete local release gate.
The [published release](https://github.com/xhluca/open-agent-view/releases/tag/v0.1.44)
contains only:

```text
open-agent-view-0.1.44-x86_64-unknown-linux-gnu.tar.gz
open-agent-view-0.1.44-x86_64-unknown-linux-gnu.tar.gz.sha256
```
...
No ARM64 or macOS artifact is claimed for v0.1.44. Version 0.1.2 was the
