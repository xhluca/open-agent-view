...
Version 0.1.38 is the current private-preview release. Hosted jobs were
unavailable, so the maintainer explicitly authorized a manual Linux x86-64
release. The [published release](https://github.com/xhluca/open-agent-view/releases/tag/v0.1.38)
contains only:

```text
open-agent-view-0.1.38-x86_64-unknown-linux-gnu.tar.gz
open-agent-view-0.1.38-x86_64-unknown-linux-gnu.tar.gz.sha256
```
...
No ARM64 or macOS artifact is claimed for v0.1.38. Version 0.1.2 was the
