...
The manually published v0.1.33 release currently covers:
...
but v0.1.33 does not claim artifacts for them because they were not built and
...
The installer stops with an explicit explanation when v0.1.33 is requested on
