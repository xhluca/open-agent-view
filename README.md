...
> [!NOTE]
> Open Agent View is an early private preview. The manually published v0.1.17
...
> [!IMPORTANT]
> v0.1.17 was packaged, checksummed, smoke-tested, and published manually after
...
manual v0.1.17 release is Linux x86-64 only. See the
