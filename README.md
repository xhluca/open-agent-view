...
> [!NOTE]
> Open Agent View is an early private preview. The manually published v0.1.27
...
> [!IMPORTANT]
> v0.1.27 was packaged, checksummed, smoke-tested, and published manually after
...
manual v0.1.27 release is Linux x86-64 only. See the
