...
if [[ ( "$version" == "0.1.13" || "$version" == "0.1.14" || "$version" == "0.1.15" || "$version" == "0.1.16" || "$version" == "0.1.17" || "$version" == "0.1.18" || "$version" == "0.1.19" || "$version" == "0.1.20" || "$version" == "0.1.21" || "$version" == "0.1.22" || "$version" == "0.1.23" || "$version" == "0.1.24" || "$version" == "0.1.25" || "$version" == "0.1.26" || "$version" == "0.1.27" || "$version" == "0.1.28" || "$version" == "0.1.29" || "$version" == "0.1.30" || "$version" == "0.1.31" || "$version" == "0.1.32" || "$version" == "0.1.33" || "$version" == "0.1.34" || "$version" == "0.1.35" || "$version" == "0.1.36" || "$version" == "0.1.37" || "$version" == "0.1.38" || "$version" == "0.1.39" || "$version" == "0.1.40" || "$version" == "0.1.41" || "$version" == "0.1.42" || "$version" == "0.1.43" ) && "$target" != "x86_64-unknown-linux-gnu" ]]; then
