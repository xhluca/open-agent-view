...
if [[ ( "$version" == "0.1.13" || "$version" == "0.1.14" || "$version" == "0.1.15" || "$version" == "0.1.16" || "$version" == "0.1.17" || "$version" == "0.1.18" || "$version" == "0.1.19" || "$version" == "0.1.20" || "$version" == "0.1.21" || "$version" == "0.1.22" || "$version" == "0.1.23" || "$version" == "0.1.24" || "$version" == "0.1.25" || "$version" == "0.1.26" ) && "$target" != "x86_64-unknown-linux-gnu" ]]; then
